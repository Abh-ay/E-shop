...
from .models import Category, Product, Brand, ShippingAdress, Profile, Cart, CartItem, Order, OrderItem
...
class BrandCategory(ListView):
    ...
    template_name = "brand-category.html"
...
def register(request):
    if request.method == "POST":
        ...
        try:
            ...
            user.save()
            try:
                shipping_addr = ShippingAdress.objects.create(
...
def checkout(request):
    ...
    creating_order(request.user.id, request.user.email)
